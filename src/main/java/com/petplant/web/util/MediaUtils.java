...
public class MediaUtils {
	...
	// 파일을 업로드할 때 해당되는 형식을 리턴하는 클래스
	// static로 만들어놓았기 때문에 이 부분은 처음부터 메모리에 올라가있는 상태이다.
	static {
		mediaMap = new HashMap<String, MediaType>(); // 키와 값을 저장해야 하기 때문에 HashMap<>를 사용
	...
	public static MediaType getMediaType(String type) {
		...
		// mediaMap안에 저장되어 있는 형식이 jpg,gif,png이면 그림파일, 아니면 일반파일로 구분함
	} 
}
